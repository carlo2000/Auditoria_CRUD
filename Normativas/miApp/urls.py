...
from .views import NormativaListView, NormativaDetailView, NormativaCreateView, NormativaUpdateView, NormativaDeleteView,NormativaListViewTabla,IncidenteListView, IncidenteCreateView, IncidenteUpdateView, IncidenteDeleteView
